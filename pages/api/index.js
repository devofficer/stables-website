    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <h1 className={styles.title}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 301.7552 70.3059" className={styles.svg}>
        ...
        <section className={styles.grid}>
          ...
          <p className={styles.description}>A industry newsletter for the next generation of coneissieurs</p>
          <form className={styles.form} action="https" method="POST">
            <input type="email" class="form-input px-4 py-3" placeholder="Your Email" />
            <button type="submit" class="bg-cyan-600 border-r-slate-600 p-3 m-3">Sign up</button>
          </form>
        </section>
